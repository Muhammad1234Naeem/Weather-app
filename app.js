            ...
            fetch(`https://api.openweathermap.org/data/2.5/weather?lat=${lat}&lon=${lon}&units=metric&appid=233a720fcff7e4f27d62707870344016`)
                ...
                .then(data1 => {
                    ...
                    if (data1.weather[0].id == 701 || data1.weather[0].id == 741) {
                        data1.weather[0].icon = "assests/img/mist.png";
                    }
                    else if (data1.weather[0].id == 711) {
                        data1.weather[0].icon = "assests/img/smoke.png";
                    }
                    else if (data1.weather[0].id == 721) {
                        data1.weather[0].icon = "assests/img/haze.png";
                    }
                    else if (data1.weather[0].id == 731) {
                        data1.weather[0].icon = "assests/img/dust.png";
                    }
                        ...
                        data1.weather[0].icon = "assests/img/sand.png";
                    }
                        ...
                        data1.weather[0].icon = "assests/img/snow.png";
                    }
                        ...
                        data1.weather[0].icon = "assests/img/scattered-thunderstorms.png";
                    }
                    ...
                    <img src="assests/img/humidity.png">
                    <span>Humidity</span>
                    </div>
                    <div class="calculate">
                    ...
                    <div class="one">
                    <div class="img_weather">
                    <img src="assests/img/clouds.png">
                    <span>Clouds</span>
                    </div>
                    <div class="calculate">
